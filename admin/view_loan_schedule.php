        ...
        <div class="row">
          <div class="col-12">
           ...
           <div class="card card-secondary">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>Loan Id</th>
                        <th>Month</th>
                        <th>Monthly Payment(Total Payments</th>
            ...
            <?php
                    $i = 1;
                    $qry = $conn->query("SELECT * FROM loan_schedule WHERE loan_id={$_GET['id']} ORDER BY loan_id DESC;");
  ...
  function delete_category($cid){
    ...
    $.ajax({
      ...
      success:function(resp){
        if(resp==1){
          alert_toast("Blog Category successfully deleted",'success')
          setTimeout(function(){
            location.reload()
          },1500)
