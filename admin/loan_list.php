        ...
        <a class="btn btn-block btn-sm btn-primary btn-flat border-primary" href="./index.php?page=add_loan_application"><i class="fa fa-plus"></i> Add Loan Application </a>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
          $i = 1;
          $qry = $conn->query("SELECT loan_list.id as lid,loan_types.loanName,loan_list.loan_amount,loan_list.loan_status,loan_list.loan_client,loan_list.loan_plan,clients.firstname,clients.lastname,loan_list.loan_date FROM loan_list JOIN loan_types ON loan_list.loan_type=loan_types.id JOIN clients ON loan_list.loan_client=clients.id ");
          while($row= $qry->fetch_assoc()):
          ?>
          <tr>
            <td class="text-center"><?php echo $i++ ?></th>
              <td><?php echo $row['lid'];?></th>
            ...
            <td class="text-center">
                        ...
                        <div class="btn-group">
                           <a href="loan_schedule.php?loan_id=<?php echo $row['lid'] ?>&loan_plan=<?php echo $row['loan_plan'] ?>" class="btn btn-success btn-flat">
                            ...
                            <a href="index.php?page=edit_loan&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat">
                              <i class="fas fa-edit"></i>
                            </a>
                            <button type="button" class="btn btn-danger btn-flat delete_loan" data-id="<?php echo $row['id'] ?>">
